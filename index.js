const sessionName = "NaInSec";
const donet = "https://github.com/NaInSec";
const owner = ["6281528978045"];
const {
  default: nainsecConnect,
...
async function startHisoka() {
  ...
  const client = sansekaiConnect({
    ...
    browser: ["Wa-OpenAI - NaInSec", "Safari", "3.0"],
    auth: state,
  });
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator BTC - 14xMeDbjsyBCtjCLsaKBYLqw4C2Sf145o5", "yellow"));
